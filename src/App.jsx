        ...
        {player.status === 'active' && (
          <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '100%', touchAction: 'none', position: 'relative' }}>
            ...
            <div style={{
                ...
                paddingLeft: isTopBot ? 10 : myArea === 'midl' ? 65 : myArea === 'midr' ? 10 : (seatIndex === 0 || seatIndex === 3) ? 95 : 10,
                paddingRight: isTopBot ? 10 : myArea === 'midr' ? 65 : myArea === 'midl' ? 10 : (seatIndex === 1 || seatIndex === 2) ? 95 : 10,
              }}
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[10000]">
          ...
          {!showResetConfirm && !showSettings && (
            <button
              ...
              style={{
                ...
                top: 'calc(50% - 17px)', left: tableLayout === 'cross' ? 'calc(50% + 72px)' : 'calc(50% + 95px)',
            ...
            <>
              ...
              {firstSeatIndex === null && !allFilled && (
                <button
                  ...
                  style={{ width: tableLayout === 'cross' ? '90px' : '120px', height: tableLayout === 'cross' ? '90px' : '120px', transform: tableLayout === 'cross' ? 'translateX(158px)' : 'none' }}
                >
          ...
          {gameStarted && !allFinished && !showSettings && !showResetConfirm && (
            <button
              ...
              style={{ 
                ...
                userSelect: 'none',
                transform: tableLayout === 'cross' ? 'translateX(158px)' : 'none',
              }}
            >
          ...
          {gameStarted && allFinished && !showSettings && !showResetConfirm && (
            <button
              ...
              style={{ width: tableLayout === 'cross' ? '90px' : '150px', height: tableLayout === 'cross' ? '90px' : '150px', transform: tableLayout === 'cross' ? 'translateX(158px)' : 'none' }}
            >
              SUBMIT
            </button>
          )}
