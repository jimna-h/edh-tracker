        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[10000]">
          <div className="flex flex-col items-center justify-center">
              ...
              <button 
                ...
                className={`pointer-events-auto font-black rounded-full transition-all flex items-center justify-center text-center p-4
                  ${allFilled ? 'bg-white text-black shadow-[0_0_40px_rgba(255,255,255,0.3)]' : 
                    ...
                    'bg-white/10 text-white/20 border border-white/10'}
                `}
            ...
            {gameStarted && !allFinished && (
              <button 
                onPointerDown={handlePointerDown} onPointerUp={handlePointerUp} 
                className="pointer-events-auto rounded-full flex items-center justify-center bg-black/90 shadow-[0_0_60px_rgba(0,0,0,1)] border border-white/5"
                style={{ width: 'clamp(100px, 20vh, 250px)', height: 'clamp(100px, 20vh, 250px)' }}
              >
                <span className="font-black tabular-nums text-white" style={{ fontSize: 'clamp(3rem, 10vh, 8rem)' }}>
                  {turn}
                </span>
              </button>
            )}
            ...
            {gameStarted && allFinished && (
              <button 
                onClick={submitGame}
                className="pointer-events-auto font-black rounded-full bg-[#D4AF37] text-black shadow-[0_0_40px_rgba(212,175,55,0.5)] p-4 tracking-tighter"
